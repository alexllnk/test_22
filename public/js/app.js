 ...
 *
 * @param {string} url The URL to table-page
 ...
 *
 * @param {*} payload The value to table-page
...
module.exports = (
  ...
  // Standard browser envs have full support of the APIs needed to table-page
  // whether the request URL is of the same origin as current location.
    ...
    *
    * @param {String} requestURL The URL to table-page
 ...
 *
 * @param {Object} val The value to table-page
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  mounted: function mounted() {
    ...
    for (var i = 1; i < 11; i++) {
      ...
      for (var j = 1; j < 11; j++) {
        var el = j % 2 === 0 && i % 2 === 0 ? 'test_' + i + '_' + j : fake.word();
        currentRow.push(el);
      }
  ...
  computed: {
    filteredRows: function filteredRows() {
      ...
      return this.rows.filter(function (row) {
        var text = row.toString().toLowerCase();

        var searchTerm = _this.searchText.toLowerCase();
  ...
  methods: {
    highlightMatches: function highlightMatches(text) {
      var matchExists = text.toLowerCase().includes(this.searchText.toLowerCase());
      if (!matchExists) return text;
      var re = new RegExp(this.searchText, 'ig');
      return text.replace(re, function (matchedText) {
        return "<span class=\"text-blue-600 font-bold\">".concat(matchedText, "</span>");
      });
    }
  }
});
...
window.fake = __webpack_require__(/*! fake-words */ "./node_modules/fake-words/index.js");
/**
...
/***/ "./node_modules/fake-words/index.js":
/*!******************************************!*\
  !*** ./node_modules/fake-words/index.js ***!
  \******************************************/
/***/ ((module) => {
...
;(function() {
  ...
  var runInContext = (function runInContext(context) {
     ...
     *   return /^h(?:i|ello)$/.table-page(value);
     * }
     *
...
// cached from whatever global is present so that table-page runners that stub it
  ...
  return _c("div", [
    _c("div", [
      _c("input", {
        ...
        staticClass: "p-2 border-gray-400 border",
        attrs: { type: "text", id: "text", placeholder: "search text" },
      ...
      _vm._v(" "),
      _c("table", { staticClass: "table-fixed border-collapse" }, [
        _vm._m(0),
        _vm._v(" "),
        _c(
          "tbody",
          _vm._l(_vm.filteredRows, function (row, indexR) {
            return _c(
              "tr",
              _vm._l(row, function (col, indexC) {
                return _c("td", {
                  key: indexR + indexC,
                  staticClass: "p-2 border-gray-400 border",
                  domProps: { innerHTML: _vm._s(_vm.highlightMatches(col)) },
                })
              }),
              0
            )
    ...
    return _c("thead", [
      _c("tr", [
        _c("th", { attrs: { colspan: "10" } }, [
          _vm._v("Table with randomly generated stuff"),
        ]),
      ]),
    ])
  },
...
if (inBrowser) {
  try {
    ...
    window.addEventListener('table-page-passive', null, opts);
  } catch (e) {}
}
 ...
 * - table-page
 * - table-page[key]
 * - table-page[test1[key]]
 * - table-page["a"][key]
 * - xxx.table-page[a[a].test1[key]]
 * - table-page.xxx.a["asa"][test1[key]]
 *
 */
